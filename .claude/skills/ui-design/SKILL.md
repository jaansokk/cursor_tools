...
name: ui-design
description: >
  Create distinctive, production-grade web interfaces with high design quality
  using Tailwind CSS. Use for building UI components, pages, dashboards, apps,
  and web applications. Generates crafted, polished code that avoids generic AI aesthetics.
---
...
No Inter, no Roboto. Here are distinctive alternatives by category:
...
- Have touch-friendly targets (minimum 44x44px)
...
- **Cliche color schemes:** Purple gradients on white, generic blue CTAs
...
- [references/tailwind-practices.md](references/tailwind-practices.md) — Tailwind-specific patterns and optimization
- [references/craft-principles.md](references/craft-principles.md) — Surface architecture, tokens, dark mode
- [references/web-design-checklist.md](references/web-design-checklist.md) — UX, accessibility, performance checklist
- [templates/design-system.md](templates/design-system.md) — Design system documentation template
